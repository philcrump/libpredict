 ...
 * \copyright GPLv2+
 **/
void predict_moon(predict_julian_date_t jul_time, struct moon *moon)
{
	double t, t2, t3, l1, m, teg, l, b, w1, w2, bt, p, lm, m1, d, ff, om, ss, ex;

	moon->jd = jul_time;

	t=(jul_time-2415020.0)/36525.0;
	t2=t*t;
	t3=t2*t;
	...
	teg=280.46061837+360.98564736629*(jul_time-2451545.0)+(0.000387933*t-t*t/38710000.0)*t;
